...
if __name__ == '__main__':
    ...
    if model_name == '1':
        model = Model1()
        save_model_name = './PDF/Model1.h5'
    elif model_name == '2':
        model = Model2()
        save_model_name = './PDF/Model2.h5'
    elif model_name == '3':
        model = Model3()
        save_model_name = './PDF/Model3.h5'
    else:
        print(bcolors.FAIL + 'invalid model name, must one of 1, 2 or 3' + bcolors.ENDC)

    # the data, shuffled and split between train and test sets
    X_train, y_train, _ = datasets.csv2numpy('./PDF/dataset/train.csv')
    X_test, y_test, _ = datasets.csv2numpy('./PDF/dataset/test.csv')
