...
from prediction.dataset.dfl import DFLDataset 
...
datasets = {
    ...
    "dfl": {
        ...
        "sample_step": 5,
        "attack_length": 6,
        "data_dir": "data/dataset/dfl/multi_frame"
    },
    "ngsim": {
        "api": NGSIMDataset,
        "obs_length": 15,
...
models = {
    ...
    "dualtransformer": {
        "apolloscape": {
            "pre_load_model": "data/dualtransformer_apolloscape/model/original/best_model.pt",
            "num_node": 120, 
            "in_channels": 4,
            "rescale": [1,1]
        },
        "ngsim": {
            "pre_load_model": "data/dualtransformer_ngsim/model/original/best_model.pt",
            "num_node": 260, 
            "in_channels": 4,
            "rescale": [669.691/2, 669.691/2]
        },
        "dfl": {
            "pre_load_model": "data/dualtransformer_dfl/model/original/best_model.pt",
            "num_node": 120, 
            "in_channels": 4,
            "rescale": [1,1]
        }
